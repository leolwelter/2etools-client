...
export default function Footer() {
    return (
        <div>
            <div className="modal" role="dialog" id="privacyModal">
                <div className="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <h4>We at 2eTools respect your privacy.</h4>
                            <p>
                                We do not require that you provide, nor do we collect, any personal information if you
                                are just browsing
                                the site.
                            </p>
                            <p>
                                Our web servers collect from site visitors: statistical information regarding what pages
                                are visited, the date
                                and time of the visits, how long it took a user to download a page, and the TCP/IP
                                address of the user. These
                                automated server functions do not collect this information in a manner intended to
                                identify your individual
                                use of 2eTools. This information is collected to assist us in maintaining a high quality
                                site, and tune our
                                website to provide a better experience for each user.
                            </p>
                            <p>In order to learn more about our users and what services and feature are most attractive
                                to our visitors we
                                may utilize cookies to assist us in collecting relevant site usage info by our visitors.
                                We may also utilize
                                the assistance of third party tools to understand how its site is being used (including
                                Google Analytics,
                                Google Adsense, etc.) and these parties may utilize cookie technology to ascertain how
                                2eTools is being
                                accessed by visitors.
                            </p>
                            <p>
                                2eTools contains links to web sites of third parties. 2eTools is not responsible for
                                the actions of these
                                third parties, including their privacy practices and any content posted on their web
                                sites. We encourage you
                                to review their privacy policies to learn more about what, why and how they collect
                                and use personal
                                information. 2eTools adheres to industry recognized standards to secure any personal
                                information in our
                                possession, and to secure it from unauthorized access and tampering. However, as is
                                true with all online
                                actions, it is possible that third parties may unlawfully intercept transmissions of
                                personal information, or
                                other users of 2eTools may misuse or abuse your personal information that they may
                                collect from 2eTools.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="modal" role="dialog" id="licenseModal">
                <div className="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Licensing</h5>
                            <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div className="modal-body">
                            <h4>Community Use Policy</h4>
                            <p>
                                This website uses trademarks and/or copyrights owned by Paizo Publishing, LLC, which are
                            ...
                            <p>The following text is the property of Wizards of the Coast, Inc. and is Copyright 2000
                            ...
                            judicial order, or governmental regulation then You may not Use any Open Game Material
                            so affected.
                        </p>
                            <p>
                            ...
                            <h4>Creative Commons 3.0 BY License</h4>
                            <p>Thank you to the wonderful contributors of <a href='https://game-icons.net/about.html#authors'>Game-icons.net</a> for their work, featured on the homepage.</p>
                            <p>Skoll</p>
                            <p>Lorc</p>
                            <p>Delapouite</p>
                ...
                <div className="col text-center">
                    <nav className="navbar navbar-light bg-light">
                        <div className="col-10 mx-auto">
                            <p className="text-gold p-default my-auto">
                                Version <span>{config.version}</span> | <span>©2020 2eTools</span> | <a
                                className='p-pointer' data-toggle="modal" data-target="#privacyModal">Privacy
                                Policy</a> | <a className='p-pointer' data-toggle="modal"
                                                data-target="#licenseModal">License</a>
                            </p>
                        </div>
                    </nav>
                </div>
